...
namespace com.rfilkov.kinect
{
    ...
    public class BackgroundRemovalManager : MonoBehaviour
    {
        ...
        [Tooltip("Offset from the highest body joint to the top of the head.")]
        [Range(0f, 0.4f)]
        public float headOffset = 0.2f;

        [Tooltip("Offset from the leftmost and rightmost body joint to the respective end of the body.")]
        [Range(0f, 0.4f)]
        private float leftRightOffset = 0.1f;

        [Tooltip("Offset from the frontmost body joint to the front end of the body.")]
        [Range(0f, 0.4f)]
        private float frontOffset = 0.2f;

        [Tooltip("Offset from the backmost body joint to the back end of the body.")]
        [Range(0f, 0.4f)]
        private float backOffset = 0.1f;

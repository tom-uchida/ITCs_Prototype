                    ...
                    lock (bodyTrackerLock)
                    {
                        if (bGetBodyData)
                        {
                            ...
                            if (rawBodyIndexImage != null)
                            {
                                ...
                                rawBodyIndexTimestamp = bodyTracker.GetBodyFrameTimestampUsec(bodyFrameHandle);
                            ...
                            rawBodyTimestamp = bodyTracker.GetBodyFrameTimestampUsec(bodyFrameHandle) + trackedBodiesCount;

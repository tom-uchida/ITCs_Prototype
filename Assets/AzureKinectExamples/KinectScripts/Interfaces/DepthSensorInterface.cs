...
namespace com.rfilkov.kinect
{
    ...
    public interface DepthSensorInterface
    {
        ...
        RenderTexture GetDepthCameraColorFrameTexture(ref Texture2D copyToTex2D, ref ulong frameTime);
        ...
        byte[] GetColorCameraBodyIndexFrame(ref ulong frameTime);
    }
}
